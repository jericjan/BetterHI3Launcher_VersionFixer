...
def browseFiles():
    global currentdir
    if path.isdir('C:\Program Files\Honkai Impact 3rd'):
        ...
        if path.isdir('C:\Program Files\Honkai Impact 3'):
